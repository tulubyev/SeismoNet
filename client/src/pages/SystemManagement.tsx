...
const SystemManagement: FC = () => {
  ...
  const items: { href: string; icon: typeof Users; title: string; desc: string; badge: number | null; color: string; bg: string; module: Module }[] = [
    ...(can('users') ? [{
