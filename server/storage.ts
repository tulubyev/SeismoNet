...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    const sampleStations: InsertStation[] = [
      { stationId:"IRK-ST-001", name:"Станция «Центр»",        location:"ул. Ленина, Иркутск",         latitude:"52.2897", longitude:"104.2963", status:"online",   lastUpdate:new Date(), dataRate:100, batteryLevel:89, firmwareVersion:"v3.1.0", hardwareModel:"СМ-3КВ", configuration:{}, isManaged:true },
      { stationId:"IRK-ST-002", name:"Станция «ГЭС»",          location:"Иркутская ГЭС",               latitude:"52.3127", longitude:"104.2218", status:"online",   lastUpdate:new Date(), dataRate:100, batteryLevel:94, firmwareVersion:"v3.1.0", hardwareModel:"СМ-3КВ", configuration:{}, isManaged:true },
      { stationId:"IRK-ST-003", name:"Станция «Мост»",         location:"Мост через р. Ушаковка",      latitude:"52.2756", longitude:"104.3312", status:"online",   lastUpdate:new Date(), dataRate:100, batteryLevel:77, firmwareVersion:"v3.1.0", hardwareModel:"СМ-3КВ", configuration:{}, isManaged:true },
      { stationId:"IRK-ST-004", name:"Станция «Академгородок»",location:"мкр. Академгородок",          latitude:"52.2604", longitude:"104.2481", status:"degraded", lastUpdate:new Date(), dataRate:60,  batteryLevel:45, firmwareVersion:"v3.0.0", hardwareModel:"СМ-3КВ", configuration:{}, isManaged:true },
      { stationId:"IRK-ST-005", name:"Станция «Иркутск-Южный»",location:"пос. Ново-Иркутский",        latitude:"52.2231", longitude:"104.3012", status:"online",   lastUpdate:new Date(), dataRate:100, batteryLevel:82, firmwareVersion:"v3.1.0", hardwareModel:"СМ-3КВ", configuration:{}, isManaged:true },
      { stationId:"IRK-ST-006", name:"Станция «Шелехов»",      location:"г. Шелехов",                  latitude:"52.2090", longitude:"104.1010", status:"online",   lastUpdate:new Date(), dataRate:100, batteryLevel:88, firmwareVersion:"v3.1.0", hardwareModel:"СМ-3КВ", configuration:{}, isManaged:true },
      { stationId:"IRK-ST-007", name:"Станция «Листвянка»",    location:"пос. Листвянка (береговая)",  latitude:"51.8599", longitude:"104.8736", status:"online",   lastUpdate:new Date(), dataRate:100, batteryLevel:91, firmwareVersion:"v3.1.0", hardwareModel:"СМ-3КВ", configuration:{}, isManaged:true },
      { stationId:"IRK-ST-008", name:"Станция «Ангарск»",      location:"г. Ангарск",                  latitude:"52.5397", longitude:"103.8897", status:"offline",  lastUpdate:new Date(Date.now()-3600000), dataRate:0, batteryLevel:12, firmwareVersion:"v3.0.0", hardwareModel:"СМ-3КВ", configuration:{}, isManaged:true }
    ];
...
const initializeDatabase = async () => {
  ...
  // ── Seed 20 diverse test objects across all districts ─────────────────────────
  const testObjects: InsertInfrastructureObject[] = [
    // ── Октябрьский район ──────────────────────────────────────────────────────
    {
      objectId: "IRK-TEST-001",
      name: "ЖК «Северное сияние-2» (ГК «Новый город»)",
      address: "ул. Депутатская, 4, Иркутск",
      objectType: "residential",
      ...
      designIntensity: 7,
      technicalCondition: "good",
      description: "22-этажный монолитный ЖК, корпус 2. Сейсмомониторинг подключён.",
      responsibleOrganization: "ГК «Новый город»",
      contactPhone: "+7 (3952) 20-00-00",
      isMonitored: true,
    },
    {
      objectId: "IRK-TEST-002",
      name: "ГБУЗ «Областная клиническая больница»",
      address: "мкр. Юбилейный, 100, Иркутск",
      objectType: "hospital",
      ...
      designIntensity: 7,
      technicalCondition: "satisfactory",
      description: "Главный корпус ОКБ. Кирпичная постройка 1979 г. Требует обследования.",
      responsibleOrganization: "ГБУЗ Иркутской области",
      contactPhone: "+7 (3952) 40-75-00",
      isMonitored: false,
    },
    {
      ...
      designIntensity: 7,
      technicalCondition: "good",
      description: "Бизнес-центр класса B+, стальной каркас с навесными фасадами.",
      responsibleOrganization: "ГК «ДомСтрой»",
      contactPhone: "+7 (3952) 39-00-39",
      isMonitored: true,
    },
    // ── Свердловский район ──────────────────────────────────────────────────────
    {
      objectId: "IRK-TEST-005",
      name: "ЖК «Сказка» корп. 3 (ПарапетСтрой)",
      address: "ул. Сухэ-Батора, 18, Иркутск",
      objectType: "residential",
      ...
      designIntensity: 7,
      technicalCondition: "good",
      description: "18-этажный монолитный ЖК «Сказка», 3-й корпус.",
      responsibleOrganization: "ПарапетСтрой",
      contactPhone: "+7 (3952) 25-25-25",
      isMonitored: false,
    },
    {
      ...
      description: "Промышленный цех 1964 г. Металлокаркас, частичный износ ограждающих конструкций.",
    ...
    // ── Ленинский район ────────────────────────────────────────────────────────
    {
      objectId: "IRK-TEST-009",
      name: "ЖК «Профит-Ленинский»",
      address: "б-р Рябикова, 45, Иркутск",
      objectType: "residential",
      ...
      designIntensity: 7,
      technicalCondition: "satisfactory",
      description: "9-этажный кирпичный дом. Состояние удовлетворительное, трещины зафиксированы.",
      responsibleOrganization: "Профит",
      contactPhone: "+7 (3952) 77-77-77",
      isMonitored: false,
    },
    {
      objectId: "IRK-TEST-010",
      name: "ЖК «Союз-Ленинский» (ГК «Грандстрой»)",
      address: "ул. Розы Люксембург, 80, Иркутск",
      objectType: "residential",
      constructionYear: 2019,
      floors: 18,
      latitude: "52.3424",
      ...
      designIntensity: 7,
      technicalCondition: "good",
      description: "18-этажный монолитный ЖК. Сейсмомониторинг подключён.",
      responsibleOrganization: "ГК «Грандстрой»",
      contactPhone: "+7 (3952) 50-50-50",
      isMonitored: true,
    },
    {
      objectId: "IRK-TEST-011",
      name: "ТЦ «Карамель»",
      address: "ул. Баррикад, 39, Иркутск",
      objectType: "admin",
      ...
      designIntensity: 7,
      technicalCondition: "satisfactory",
      description: "Торгово-развлекательный центр. Металлический каркас с навесными панелями.",
      responsibleOrganization: "ООО «Карамель»",
      contactPhone: "+7 (3952) 31-10-10",
      isMonitored: true,
    },
    {
      objectId: "IRK-TEST-012",
      name: "ОГБУЗ «Детская больница №6»",
      address: "ул. Трудовая, 14, Иркутск",
      objectType: "hospital",
      constructionYear: 1958,
      floors: 4,
      latitude: "52.2114",
      ...
      designIntensity: 7,
      technicalCondition: "poor",
      description: "Кирпичное здание 1958 г. постройки. Трещины несущих стен, требует немедленного обследования.",
      responsibleOrganization: "ОГБУЗ Иркутской области",
      contactPhone: "+7 (3952) 46-00-00",
      isMonitored: false,
    },
    // ── Правобережный район ────────────────────────────────────────────────────
    {
      objectId: "IRK-TEST-013",
      name: "ЖК «Альфа-2» (Альфа)",
      address: "ул. Напольная, 4, Иркутск",
      objectType: "residential",
      constructionYear: 2023,
      floors: 18,
      latitude: "52.2948",
      ...
      designIntensity: 7,
      technicalCondition: "good",
      description: "18-этажный монолитный ЖК, 2-я очередь. Датчики установлены.",
      responsibleOrganization: "Альфа",
      contactPhone: "+7 (3952) 90-90-90",
      isMonitored: true,
    },
    {
      objectId: "IRK-TEST-014",
      name: "ГБПОУ «Иркутский политехнический колледж»",
      address: "ул. Угольная, 68, Иркутск",
      objectType: "school",
      ...
      designIntensity: 7,
      technicalCondition: "satisfactory",
      description: "Кирпичное здание. Плановый ремонт кровли выполнен в 2023 г.",
      responsibleOrganization: "МО Иркутской области",
      contactPhone: "+7 (3952) 34-56-78",
      isMonitored: false,
    },
    {
      objectId: "IRK-TEST-015",
      name: "Производственная база «Иркутскэнерго»",
      address: "ул. Рабочего Штаба, 11, Иркутск",
      objectType: "industrial",
      ...
      seismicCategory: "III",
      designIntensity: 7,
      technicalCondition: "critical",
      description: "Стальной каркас 1952 г. КРИТИЧЕСКОЕ состояние — наклон колонн, аварийные деформации.",
      responsibleOrganization: "ПАО «Иркутскэнерго»",
    ...
    // ── Иркутский район ───────────────────────────────────────────────────────
    {
      ...
      name: "ЖК «Пригородный» (ГК «Новый город»)",
      address: "пос. Молодёжный, ул. Центральная, 7",
      objectType: "residential",
      constructionYear: 2016,
      floors: 9,
      latitude: "52.2100",
      ...
      designIntensity: 7,
      technicalCondition: "satisfactory",
      description: "Панельный 9-этажный жилой дом. Состояние удовлетворительное.",
      responsibleOrganization: "ГК «Новый город»",
      contactPhone: "+7 (3952) 20-00-00",
      isMonitored: true,
    },
    {
      objectId: "IRK-TEST-018",
      name: "Коттеджный посёлок «Берёзовый»",
      address: "пос. Берёзовый, Иркутский район",
      objectType: "residential",
      constructionYear: 2018,
      floors: 2,
      latitude: "52.1950",
      ...
      designIntensity: 6,
      technicalCondition: "good",
      description: "Малоэтажная деревянная застройка. Сейсмостойкость по СП14 для 6 баллов.",
      responsibleOrganization: "Иркутский район",
      contactPhone: "+7 (3952) 00-00-00",
      isMonitored: false,
    },
    {
      objectId: "IRK-TEST-019",
      name: "МОУ «Школа посёлка Иркутский»",
      address: "пос. Иркутский, ул. Школьная, 1",
      objectType: "school",
      ...
      designIntensity: 7,
      technicalCondition: "good",
      description: "Кирпичная школа 1988 г. Капитальный ремонт 2021 г.",
      responsibleOrganization: "Администрация Иркутского района",
      contactPhone: "+7 (3952) 55-55-55",
      isMonitored: false,
    },
    {
      objectId: "IRK-TEST-020",
      name: "ПК «Иркутскагро» (промкомплекс)",
      address: "пос. Маркова, промзона, участок 12",
      objectType: "industrial",
      ...
      designIntensity: 6,
      technicalCondition: "poor",
      description: "Кирпичный склад 1975 г. Деформации кровли, частичное разрушение карниза.",
      responsibleOrganization: "АО «Иркутскагро»",
      contactPhone: "+7 (3952) 11-22-33",
      isMonitored: false,
    },
  ];
  ...
  const installPairs: { stationId: string; objectIdCode: string; location: string; installationDate: Date; sensorType: string }[] = [
    { stationId: 'IRK-ST-001', objectIdCode: 'IRK-TEST-001', location: 'ground_floor', sensorType: 'accelerometer', installationDate: new Date('2024-03-01') },
  ...
  for (const pair of installPairs) {
    const obj = objectByCode(pair.objectIdCode);
    if (!obj) continue;
    if (!hasInstall(pair.stationId, obj.id)) {
      await dbStorage.createSensorInstallation({
        stationId: pair.stationId,
        objectId: obj.id,
        installationLocation: pair.location,
        sensorType: pair.sensorType,
        installationDate: pair.installationDate,
        isActive: true,
      });
    }
  }
  console.log('Station-object sensor installations seeded (skipped if already present).');
